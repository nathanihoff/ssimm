...
Finally, this is an analysis of cohabiting couples. This particular focus has a two-part justification: the DOMA decision itself carries significant relevance to couples and, therefore, the American Community Survey's attention to cohabitating couples is appropriate. Nevertheless, this means our findings are unable to be generalized to non-cohabitating couples nor single migrants. Future incorporation of these different types of LGB immigrants and relationship formations, especially within nationally representative surveys, is thus urgently needed. The incorporation of such individuals may likely augment the findings presented here in a few particular ways. For example, as mentioned, supportive policy environments may both be the result of and further reinforce self-disclosure and same-sex coupledom. Consequently, data on single LGB migrants may include a more diverse set of origin policy environments. However, we believe that the incorporation of single and non-cohabitating migrants will likely strengthen the present findings. This is because current qualitative data highlights how LGB individuals within repressive contexts who are able to migrate are among the elite -- thus reinforcing the current socioeconomic demographics we present [@choi_2022_global]. Moreover, family-based migration like the sponsorship of spousal and fiance visas is less positively selective than other visa pathways [xx]. Rather than having a U.S. partner to help assist the visa process, that likely means single LGB individuals will enter the U.S. through other pathways like employment, education, or asylum. Given the scale of visas offered, these other pathways likely even more positively select pionering migrants with high socioeconomic status and those also coming from progressive countries, overall. Their inclusion within the ACS, then, will likely enhance present findings. Finally, although the cultural and geographic variation in responses shown in Table \@ref(tab:country-tab) suggests that responses are not a function of culture alone, future work must attend to whether response rates correlate with country-of-origin policies. Nevertheless, our results cannot generalize to U.S. immigrants who remain single or do not cohabit, whether LGB or straight. 
