...
## Analytic Strategy 
Many of our analyses rely on descriptive statistics of ACS data. For these, we apply survey weights from the ACS.  
...
```{r desc-country, fig.height = 6.5, fig.cap = 'Origin country-level descriptive statistics for immigrants in couples 2008-2019, for year of migration, with survey weights and 95% confidence intervals. Currency in thousands of 1999 dollars.'}
