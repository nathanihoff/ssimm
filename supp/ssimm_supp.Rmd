...
```{r scatter-country, fig.cap = "Proportion of immigrants from each country in same-sex couples in each year of immigration, from 1991 to 2019. The horizontal axis indicates the policy score of the country of origin in the year of immigration. Points are jittered for clarity, and percentages above 20 are not shown."}

acs_prop_yrimmig_policy %>%
  filter(prop_same_sex < 20) %>%
...
```{r scatter-state, fig.cap = "Proportion of immigrants from each country in same-sex couples in each state, in each survey year, from 2008 to 2019. The left panel's horizontal axis represents the origin country policy score in the mean year of immigration for that group, while the right panel's horizontal axis represents the state policy score in the survey year. Points are jittered for clarity, and percentages above 20 are not shown."}
...
stargazer(mod_list,
          ...
          title = 'Alternate specifications of OLS regressions of percent of immigrants in same-sex couples by year of immigration and country of origin, including only married couples.')
```
...
stargazer(mod_list,
          ...
          covariate.labels = c('Country LGB policy score', 
                                'Post-2013', 'Country score × Post-2013'),
          dep.var.labels   = c("One immigrant", "Two immigrants"),
          ...
          title = 'Alternate specifications of OLS regressions of percent of immigrants in same-sex couples by year of immigration and country of origin, using only proportions of couples with one immigrant and one U.S.-born citizen or two immigrants.')
```
...
stargazer(mod_list,
          ...
          title = 'OLS regressions of proportion of recent of immigrants in same-sex couples by year of immigration and country of origin.')
```
