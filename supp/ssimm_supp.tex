...
\\[-1.8ex] & (1) & (2) & (3) & (4)\\ 
\hline \\[-1.8ex] 
 Same-sex & 0.350$^{***}$ (0.009) & 0.250$^{***}$ (0.012) & 23.000$^{***}$ (0.0001) & 19.000$^{***}$ (0.00000) \\ 
  Country LGB policy score &  & $-$0.040$^{***}$ (0.001) & $-$0.046$^{***}$ (0.001) & $-$0.006$^{***}$ (0.002) \\ 
  Male &  &  & $-$0.170$^{***}$ (0.004) & $-$0.089$^{***}$ (0.0002) \\ 
  Age &  &  & 0.015$^{***}$ (0.0002) & 0.008$^{***}$ (0.0002) \\ 
  Education: college &  &  & 0.042$^{***}$ (0.003) & $-$0.150$^{***}$ (0.0003) \\ 
  Education: high school &  &  & 0.051$^{***}$ (0.004) & $-$0.072$^{***}$ (0.0001) \\ 
  Education: some college &  &  & 0.005 (0.004) & $-$0.061$^{***}$ (0.00002) \\ 
  Number of children &  &  & 0.013$^{***}$ (0.002) & 0.029$^{***}$ (0.002) \\ 
  IHS-transformed income &  &  & 0.120$^{***}$ (0.001) & 0.041$^{***}$ (0.001) \\ 
  No income &  &  & 0.200$^{***}$ (0.001) & 0.009$^{***}$ (0.0003) \\ 
  Year of immigration &  &  & 0.016$^{***}$ (0.00001) & 0.024$^{***}$ (0.00002) \\ 
  Distance (km) &  &  &  & 0.0001$^{***}$ (0.00000) \\ 
  Contiguous border &  &  &  & 0.260$^{***}$ (0.001) \\ 
  Common official language &  &  &  & 0.077$^{***}$ (0.0002) \\ 
  Common ethnic language &  &  &  & $-$0.180$^{***}$ (0.0004) \\ 
  Ever colonial relationship &  &  &  & $-$0.015$^{***}$ (0.0003) \\ 
  Per-cap. GDP difference &  &  &  & $-$0.001$^{**}$ (0.001) \\ 
  Unemployment difference &  &  &  & $-$0.220$^{***}$ (0.0001) \\ 
  Liberal democracy (V-Dem) &  &  &  & 1.500$^{***}$ (0.0001) \\ 
  Proportion same-country stock &  &  &  & 0.230$^{***}$ (0.001) \\ 
  State unemployment rate &  &  &  & 0.510$^{***}$ (0.001) \\ 
  State per-capita income &  & 0.052$^{***}$ (0.003) & 0.048$^{***}$ (0.004) & 0.009$^{***}$ (0.0002) \\ 
  Same-sex × country score &  &  & 0.170$^{***}$ (0.001) & $-$0.030$^{***}$ (0.00001) \\ 
  Same-sex × Male &  &  & $-$0.010$^{***}$ (0.001) & $-$0.011$^{***}$ (0.001) \\ 
  Same-sex × Age &  &  & 0.200$^{***}$ (0.001) & 0.260$^{***}$ (0.00001) \\ 
  Same-sex × Education: college &  &  & 0.055$^{***}$ (0.0004) & 0.160$^{***}$ (0.00001) \\ 
  Same-sex × Education: high school &  &  & 0.200$^{***}$ (0.0003) & 0.290$^{***}$ (0.00000) \\ 
  Same-sex × Education: some college &  &  & $-$0.084$^{***}$ (0.008) & $-$0.025$^{***}$ (0.0001) \\ 
  Same-sex × Number of children &  &  & 0.063$^{***}$ (0.005) & 0.029$^{***}$ (0.0001) \\ 
  Same-sex × IHS-transformed income &  &  & 0.350$^{***}$ (0.001) & 0.350$^{***}$ (0.00001) \\ 
  Same-sex × No income &  &  & $-$0.011$^{***}$ (0.00002) & $-$0.009$^{***}$ (0.00002) \\ 
 \hline \\[-1.8ex] 
Individual controls? & no & no & yes & yes \\ 
