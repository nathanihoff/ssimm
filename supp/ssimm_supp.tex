...
\cline{2-4} 
\\[-1.8ex] & \multicolumn{3}{c}{Percentage same-sex} \\ 
\\[-1.8ex] & (1) & (2) & (3)\\ 
\hline \\[-1.8ex] 
...
\begin{table}[H] \centering 
  \caption{Individual OLS analysis of state policy score.} 
  \label{tab:ols} 
...
\\[-1.8ex] & (1) & (2) & (3) & (4)\\ 
\hline \\[-1.8ex] 
 Same-sex & 0.540$^{***}$ & 0.420$^{***}$ & 22.000$^{*}$ & 21.000$^{***}$ \\ 
  & (0.029) & (0.041) & (9.700) & (6.200) \\ 
  & & & & \\ 
 Country LGB policy score &  & $-$0.045$^{***}$ & $-$0.070$^{***}$ & 0.015$^{***}$ \\ 
  &  & (0.001) & (0.001) & (0.001) \\ 
  & & & & \\ 
 Same-sex × country score &  & 0.064$^{***}$ & 0.048$^{***}$ & $-$0.008 \\ 
  &  & (0.011) & (0.013) & (0.008) \\ 
  & & & & \\ 
\hline \\[-1.8ex] 
...
\\[-1.8ex] & (1) & (2) & (3) & (4)\\ 
\hline \\[-1.8ex] 
 Same-sex & 0.350$^{***}$ (0.009) & 0.250$^{***}$ (0.012) & 23.000$^{***}$ (0.00000) & 15.000$^{***}$ (0.00000) \\ 
  Country LGB policy score &  & $-$0.041$^{***}$ (0.0003) & $-$0.048$^{***}$ (0.0003) & $-$0.003$^{***}$ (0.001) \\ 
  Male &  &  & $-$0.140$^{***}$ (0.002) & $-$0.062$^{***}$ (0.0001) \\ 
  Age &  &  & 0.013$^{***}$ (0.0001) & 0.007$^{***}$ (0.0001) \\ 
  Education: college &  &  & 0.037$^{***}$ (0.001) & $-$0.150$^{***}$ (0.0001) \\ 
  Education: high school &  &  & 0.056$^{***}$ (0.001) & $-$0.026$^{***}$ (0.00004) \\ 
  Education: some college &  &  & 0.022$^{***}$ (0.001) & $-$0.045$^{***}$ (0.00001) \\ 
  Number of children &  &  & 0.004$^{***}$ (0.001) & 0.017$^{***}$ (0.001) \\ 
  IHS-transformed income &  &  & 0.120$^{***}$ (0.0004) & 0.036$^{***}$ (0.0004) \\ 
  No income &  &  & 0.220$^{***}$ (0.0002) & 0.002$^{***}$ (0.0001) \\ 
  Year of immigration &  &  & 0.016$^{***}$ (0.00000) & 0.022$^{***}$ (0.00001) \\ 
  Distance (km) &  &  &  & 0.0001$^{***}$ (0.00000) \\ 
  Contiguous border &  &  &  & 0.210$^{***}$ (0.0002) \\ 
  Common official language &  &  &  & 0.055$^{***}$ (0.0001) \\ 
  Common ethnic language &  &  &  & $-$0.150$^{***}$ (0.0001) \\ 
  Ever colonial relationship &  &  &  & $-$0.015$^{***}$ (0.0001) \\ 
  Per-cap. GDP difference &  &  &  & $-$0.001$^{***}$ (0.0002) \\ 
  Unemployment difference &  &  &  & $-$0.160$^{***}$ (0.00003) \\ 
  Liberal democracy (V-Dem) &  &  &  & 1.700$^{***}$ (0.00004) \\ 
  Proportion same-country stock &  &  &  & 0.230$^{***}$ (0.0004) \\ 
  State unemployment rate &  &  &  & 0.520$^{***}$ (0.0002) \\ 
  State per-capita income &  & 0.054$^{***}$ (0.003) & 0.050$^{***}$ (0.00004) & 0.008$^{***}$ (0.00002) \\ 
  Same-sex × country score &  &  & 0.140$^{***}$ (0.00001) & $-$0.059$^{***}$ (0.00000) \\ 
  Same-sex × Male &  &  & $-$0.008$^{***}$ (0.001) & $-$0.010$^{***}$ (0.001) \\ 
  Same-sex × Age &  &  & 0.200$^{***}$ (0.00001) & 0.250$^{***}$ (0.00000) \\ 
  Same-sex × Education: college &  &  & 0.049$^{***}$ (0.00001) & 0.110$^{***}$ (0.00000) \\ 
  Same-sex × Education: high school &  &  & 0.180$^{***}$ (0.00001) & 0.280$^{***}$ (0.00000) \\ 
  Same-sex × Education: some college &  &  & $-$0.075$^{***}$ (0.00001) & $-$0.011$^{***}$ (0.00000) \\ 
  Same-sex × Number of children &  &  & 0.062$^{***}$ (0.00002) & 0.033$^{***}$ (0.00001) \\ 
  Same-sex × IHS-transformed income &  &  & 0.320$^{***}$ (0.00000) & 0.350$^{***}$ (0.00000) \\ 
  Same-sex × No income &  &  & $-$0.011$^{***}$ (0.00002) & $-$0.008$^{***}$ (0.00002) \\ 
 \hline \\[-1.8ex] 
Individual controls? & no & no & yes & yes \\ 
...
\hline 
\hline \\[-1.8ex] 
\multicolumn{5}{l}{\parbox[t]{\textwidth}{\textit{Note}: †\textit{p}<0.1; *\textit{p}<0.05; **\textit{p}<0.01; ***\textit{p}<0.001. Country and state two-way clustered standard errors are shown in parentheses.}} \\ 
\multicolumn{5}{l}{\textit{Source}: American Community Survey 2008-2019} \\ 
\end{tabular} 
\end{table}
