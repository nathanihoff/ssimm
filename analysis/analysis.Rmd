...
lgbt_policy %>% filter(Country == "Côte d'Ivoire")
...
lgbt_policy$iso_o <- countrycode(lgbt_policy$Country, origin = 'country.name', destination = 'iso3c')
...
acs_dyad_policy$iso_o <- countrycode(acs_dyad_policy$Country, origin = 'country.name', destination = 'iso3c')
