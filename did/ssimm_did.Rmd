...
Though studies on union formation commonly focus individual-level characteristics (e.g., educational attainment, economic status, etc.), we turn to broader interactions between culture and policy to explain different union arrangements. As explained in more detail below, we do this given the recency of same-sex unions as both cultural and legal possibilities. But prior to getting to our specific case, we first situate our research question within a general theoretical framework. Specifically, we use existing research to understand the salience of culture in driving desires around sexuality and marriage, on the one hand, and the policies that govern these desires, on the other. 

Marriage and cohabitation are inextricably woven into cultural processes that operate at multiple scales. For example, the notion that one enters into and out of unions based on their own individual volition is a distinct cultural product formed as part of expanding liberalism and consumer logics [@wang_2018_coming]. These global processes have weakened family-arranged marriages and created the space for individual preferences to hold greater significance in union formation [@yu_2015_changes]. Yet, these “individual preferences” are also influenced by the cultural environment in which people are embedded [@hiekel_2014_understanding; @lappegard_2018_why). [expand on union selection preferences]. Even at the most intimate of scales,“when, where, how, why, and with whom” of sexual behaviors themselves are culturally determined [@Ahmadi_2003migration].

Before presenting potential explanations for this diverging trend, we present a general theoretical framework for understanding the significance of our research question. To do so, we bring together scholarship on union formation, culture, public policy, and queer migration.
