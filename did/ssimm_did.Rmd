...
huxreg(list('Full sample' = mod_mixed, 'Progressive' = mod_os_high, 'Regressive' = mod_os_low),
  ...
  huxtable::set_caption('Triple-differences (DDD), quasi-Poisson regressions of counts of 
                        individuals in mixed-citizenship, same-sex couples couples, stratifying the sample by policy environment at year of immigration')
  # theme_compact()
...
huxreg(list('Full sample' = mod_mixed, 'Progressive' = mod_os_high, 'Regressive' = mod_os_low),
  ...
  regressions of counts of individuals in mixed-citizenship, same-sex couples couples, stratifying by 
...
<!-- displays coefficients from the three-way interaction of interest, showing the logged relative incidence of mixed-citizenship, same-sex couples couples after 2013. Coefficients in models focusing on progressive policies are mostly positive. Notably, coefficients for civil unions and marriage equality are especially high.   -->
...
huxreg(list('Full sample' = mod_mixed, 'Progressive' = mod_os_high, 'Regressive' = mod_os_low),
  ...
  huxtable::set_caption('Quasi-Poisson DDD regressions of counts of 
                        mixed-citizenship, same-sex couples couples, stratifying by state-country-year-group average policy environment')
