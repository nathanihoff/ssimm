...
5. In Section C of the Online Appendix, we conduct additional DDD analyses where individuals who migrated in year $t$ are assigned the country-of-origin LGB policy score of year $t-1$, $t-2$, or $t-5$. Results are nearly identical across specifications.
