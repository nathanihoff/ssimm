...
The dramatic rise in mixed-citizenship, same-sex unions found by Redpath may result from two distinct mechanisms: (1) increased entry into such unions of individuals already residing in the U.S. or (2) new immigration of one or both members of the couple into the U.S. as a result of the policy shift.^3^ Regardless of pathway, rising trends invite us to ask new questions: What are the characteristics of immigrants selecting into these relationships? How does one's country of origin condition entering into such a union?
