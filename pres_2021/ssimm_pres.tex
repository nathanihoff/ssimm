...
\begin{frame}[fragile]{Model Results: State Effects (Table 4)}
\protect\hypertarget{model-results-state-effects-table-4}{}
\begin{verbatim}
## Error in eval(predvars, data, env): object 'same_prop' not found
\end{verbatim}
...
\begin{verbatim}
## Error in eval(expr, envir, enclos): object 'state_prop_fe' not found
\end{verbatim}
