...
- This population is particularly sensitive to changing policy
    ...
    + Growing awareness of LGBTQ+ rights within global discourses increases the saliency of considering such policies to motivate migration
...
- Policies not explicitly related to migration may shape migration flows
    ...
    + Incorporating an aspirations-capabilities framework is a fruitful strategy moving forward (De Haas 2021)
