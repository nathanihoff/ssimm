...
\begin{verbatim}
## Error: Problem with `summarise()` column `var`.
## i `var = survey_mean(polity5, vartype = "ci", na.rm = T)`.
## x object 'polity5' not found
## i The error occurred in group 1: year = 2008, same_sex = "Different-Sex".
\end{verbatim}

\begin{verbatim}
## Error in list2(...): object 'polity5' not found
\end{verbatim}
\end{frame}
