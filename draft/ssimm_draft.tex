...
\hline \\[-1.8ex] 
 & \multicolumn{5}{c}{\textit{Dependent variable:}} \\ 
\cline{2-6} 
\\[-1.8ex] & \multicolumn{4}{c}{Binned state LGBT policy score} & Continuous \\ 
\\[-1.8ex] & \multicolumn{4}{c}{\textit{ordered}} & \textit{OLS} \\ 
 & \multicolumn{4}{c}{\textit{logistic}} & \textit{} \\ 
\\[-1.8ex] & (1) & (2) & (3) & (4) & (5)\\ 
\hline \\[-1.8ex] 
 same\_sex & 0.170$^{***}$ & 0.120$^{***}$ & 16.000$^{***}$ & 1.600$^{***}$ & 1.200 \\ 
  & (0.021) & (0.028) & (0.0004) & (0.00001) & (4.900) \\ 
  & & & & & \\ 
 origin\_score &  & $-$0.047$^{***}$ & $-$0.016$^{***}$ & 0.004 & 0.016$^{***}$ \\ 
  &  & (0.003) & (0.003) & (0.005) & (0.003) \\ 
  & & & & & \\ 
 same\_sexTRUE:origin\_score &  & 0.033$^{***}$ & 0.044$^{***}$ & $-$0.004 & $-$0.009 \\ 
  &  & (0.008) & (0.009) & (0.011) & (0.006) \\ 
  & & & & & \\ 
\hline \\[-1.8ex] 
Observations & 111,347 & 111,347 & 111,347 & 102,971 & 102,971 \\ 
\hline 
\hline \\[-1.8ex] 
\multicolumn{6}{l}{Note: †p<0.1; *p<0.05; **p<0.01; ***p<0.001} \\ 
\multicolumn{6}{l}{Source: American Community Survey 2008-2019} \\ 
