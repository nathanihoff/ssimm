...
\hypersetup{
  ...
  pdfkeywords={immigration, same-sex couples, LGBQ policy, sexuality},
  colorlinks=true,
  linkcolor=blue,
  filecolor=Maroon,
  citecolor=Blue,
...
\begin{figure}
\centering
\includegraphics{ssimm_draft_files/figure-latex/state-sim2-1.pdf}
\caption{\label{fig:state-sim2}Predicted percentage of immigrants in same-sex couples by country-state, using Model 4 from Table 4.}
\end{figure}
