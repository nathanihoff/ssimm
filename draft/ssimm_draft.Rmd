...
#         sim_dat[, var] <- val
# 
#         pred_dat <- predict(ag_2013_int_fe, newdata = sim_dat, interval = 'confidence') %>%
#           as.data.frame()
#         
#        sim[[paste0(var,cat_loop, val, i)]] <- pred_dat %>%
#          summarize(fit = mean(fit, na.rm = T),
#                    fit.low = mean(lwr, na.rm = T),
#                    fit.high = mean(upr, na.rm = T),
#                           post_2013 = cat_loop,
#                           # variable = var,
#                           origin_score = val)
#     }
