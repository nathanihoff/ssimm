...
```{r ord}
ord_basic <- MASS::polr(state_policy_binned ~ same_sex + as.factor(year),
                data = acs_couple_policy_small, Hess = T)
ord_orig <- MASS::polr(state_policy_binned ~ same_sex*origin_score + as.factor(year),
                data = acs_couple_policy_small, Hess = T)
ord_interact <- MASS::polr(state_policy_binned ~ same_sex*(origin_score + gender + age + educ + 
