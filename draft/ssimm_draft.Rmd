...
# Analytic Strategy
Our first goal is to isolate the effects of country-of-origin LGB policy on the immigration of immigrants in same-sex couples. The ideal survey would follow potential immigrants over time and have information about sexual orientation, allowing us to estimate how the probability of migrating and choice of U.S. state of residence vary by sexual orientation. This ideal dataset does not exist, but we approximate it by conducting three sets of analyses, reshaping the data in different ways to test different aspects of our theory (see Table \ref{tab:analytic}).  
...
tibble(`Analytic Strategy` = c(1,2,3),
       Name = c('Country-of-Origin Effects',
                ...
                'Individual Analysis'),
           `Dependent Variable` = 
             c('Proportion of immigrants in same-sex couples, for each country in each of year of immigration 1991-2019',
